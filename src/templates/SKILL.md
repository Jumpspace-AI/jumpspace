...
description: Use repo-local Jumpspace intent memory before editing feature behavior.
---
...
Use this workflow by default for repo questions, feature work, branch review, and handoffs. The user should not have to say "use Jumpspace" on every request once this skill is installed. If Jumpspace evidence is missing, weak, or stale, say that clearly and then fall back to normal code search.
