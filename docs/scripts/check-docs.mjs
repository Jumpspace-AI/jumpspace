...
const contentChecks = [
  ['src/content/docs/index.md', ['implementation memory', 'add-skill --all', 'ask "What does this repo know?"', 'alpha software', '@jumpspace/cli']],
  ...
  ['src/content/docs/reference/json-schemas.md', ['ok": false', 'schema show work', 'alpha software']],
